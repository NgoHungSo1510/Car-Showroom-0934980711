    ...
    <div className="pt-24 pb-16 min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-text-primary mb-4">Tìm kiếm</h1>
            ...
            <div className="flex gap-2">
              <div className="flex-1 flex items-center bg-surface border border-border rounded-xl px-4 focus-within:border-primary transition-colors">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-none focus:outline-none focus:ring-0 text-text-primary px-3 py-3"
                />
              </div>
            ...
            <div className="mb-6">
              {isLoading ? (
                ...
                <p className="text-text-secondary">
                  Tìm thấy <span className="text-text-primary font-bold">{cars.length}</span> xe và{' '}
                  <span className="text-text-primary font-bold">{posts.length}</span> bài viết cho "
                  {query}"
                </p>
              )}
            </div>
              ...
              <section className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {cars.map((car: Car, index: number) => (
                    ...
                    >
                      <Link to={`/cars/${car.slug}`} className="block card group overflow-hidden">
                        ...
                        <div className="p-4">
                          ...
                          <p className="text-primary font-bold mt-2">{formatPrice(car.price)}</p>
                        </div>
                      </Link>
                    </motion.div>
                  ))}
