      ...
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-surface border-border rounded-lg text-sm py-2.5 px-3 text-text-primary focus:ring-primary focus:border-primary"
              >
            ...
            <div className="flex items-end">
              {hasActiveFilters && (
                <button
                  ...
                  className="w-full py-2.5 text-sm font-medium text-text-secondary hover:text-text-primary border border-border hover:border-primary rounded-lg transition-colors"
                >
                  Xóa bộ lọc
                </button>
              )}
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            <svg
              className="size-16 mx-auto mb-4 text-text-secondary opacity-50"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <h3 className="text-lg font-bold text-text-primary mb-2">Không tìm thấy xe</h3>
