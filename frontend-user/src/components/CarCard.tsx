                ...
                <div className="relative h-52 overflow-hidden bg-gradient-to-b from-surface-hover to-surface">
                    {car.thumbnail ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                            <svg className="size-16 text-text-secondary opacity-30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {car.model3D?.hasModel && (
                        <div className="absolute top-3 right-3 px-2 py-1 bg-primary text-white text-xs font-bold rounded animate-glow">
                            3D
                        </div>
                    )}
