...
const CarsPage: React.FC = () => {
    ...
    const filteredCars = useMemo(() => {
        return cars.filter((car: { name: string; brand?: { _id: string }; carType?: { _id: string }; status: string }) => {
        ...
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {filteredCars.length > 0 ? (
                    filteredCars.map((car: { _id: string; name: string; thumbnail?: string; brand?: { name: string }; price: number; status: string; viewCount: number; model3D?: { hasModel: boolean } }) => (
                        <div
                            key={car._id}
                        ...
                        >
                            ...
                            <div className="p-4">
                                <div className="flex items-start justify-between mb-2">
                                    ...
                                    <span className={`px-2 py-1 text-[10px] font-bold rounded uppercase ${car.status === 'published'
                    ...
                    <div className="col-span-full bg-card-dark border border-border-dark rounded-2xl p-12 text-center">
                        <span className="material-symbols-outlined text-4xl text-slate-600 mb-4">directions_car</span>
