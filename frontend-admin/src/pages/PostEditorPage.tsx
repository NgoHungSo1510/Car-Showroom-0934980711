    ...
    useEffect(() => {
        if (postData) {
            setFormData({
                ...
                eventStartDate: postData.eventStartDate ? new Date(postData.eventStartDate).toISOString().slice(0, 16) : '',
                eventEndDate: postData.eventEndDate ? new Date(postData.eventEndDate).toISOString().slice(0, 16) : '',
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                            ...
                            <button
                                key={cat.value}
                                type="button"
                                onClick={() => setFormData({ ...formData, category: cat.value as PostInput['category'] })}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, discountAmount: Number(e.target.value) || undefined })}
                                    className="w-full bg-background-dark border-border-dark rounded-lg px-4 py-3 text-white focus:ring-primary focus:border-primary"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, discountPercent: Number(e.target.value) || undefined })}
                                    className="w-full bg-background-dark border-border-dark rounded-lg px-4 py-3 text-white focus:ring-primary focus:border-primary"
                                    placeholder="VD: 15"
                                    min="0"
                                    max="100"
                    ...
                    <div className="space-y-4">
                            ...
                            >
                                ...
                                {block.type === 'image' && (
                                    <div className="space-y-3">
                                        ...
                                        />
                                        {block.url && (
                                            <img src={block.url} alt="" className="max-h-32 rounded-lg" />
                                        )}
                                    </div>
                                )}
                        ...
                        {(!formData.contentBlocks || formData.contentBlocks.length === 0) && (
                            <div className="text-center py-8 text-slate-500">
                                ...
                                <p className="text-sm">Nhấn các nút phía trên để thêm văn bản, ảnh, video hoặc gắn xe</p>
                            </div>
                        )}
                    </div>
                </div>
