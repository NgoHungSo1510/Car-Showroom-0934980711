...
export const getPosts = asyncHandler(async (req: Request, res: Response) => {
    ...
    const [posts, total] = await Promise.all([
        Post.find(query)
            ...
            .select('title slug excerpt coverImage category tags publishedAt viewCount relatedCar eventStartDate eventEndDate discountAmount discountPercent discountDescription')
            .sort(sort as string)
            .skip(skip)
            .limit(limitNum),
